...
/* Shared styles */
const inputBase = 'h-10 w-full rounded px-4 text-sm bg-transparent text-[var(--semantic-text-primary)] border transition-all duration-200 focus:outline-none';
...
function Card({ title, children, className = '' }) {
  return (
    <div className={`rounded-lg border border-[var(--semantic-border-layout)] bg-transparent shadow-sm ${className}`}>
      {title && (
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 whitespace-nowrap h-10 px-6 rounded text-sm font-medium border border-[var(--semantic-error-border)] bg-transparent text-[var(--semantic-error-primary)] hover:bg-[var(--semantic-error-surface)] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--semantic-error-primary)] focus-visible:ring-offset-2"
          >
