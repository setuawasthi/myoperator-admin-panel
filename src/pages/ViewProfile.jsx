        ...
        <div className="w-full lg:w-80 shrink-0 space-y-5">
          ...
          <div className="rounded-lg border-t-4 border-t-[var(--semantic-brand)] border-x border-b border-[var(--semantic-border-layout)] bg-[var(--semantic-bg-primary)] shadow-sm">
            ...
            <div className="px-5">
              ...
              />
              <InfoItem
                icon={<svg className="w-4 h-4 text-[var(--semantic-text-muted)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M15 15l6-6m0 0l-6-6m6 6H9a6 6 0 00-6 6v3" /></svg>}
