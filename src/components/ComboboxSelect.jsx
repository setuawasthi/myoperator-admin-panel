...
export default function ComboboxSelect({
  ...
  const inputBase = 'h-10 w-full rounded px-4 pr-10 text-sm bg-[var(--semantic-bg-primary)] text-[var(--semantic-text-primary)] border transition-colors duration-200';
