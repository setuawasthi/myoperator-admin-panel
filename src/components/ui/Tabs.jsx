      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={`px-5 py-3 text-sm font-medium transition-all border-b-2 -mb-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--semantic-brand)] focus-visible:ring-offset-2 ${
              isActive
